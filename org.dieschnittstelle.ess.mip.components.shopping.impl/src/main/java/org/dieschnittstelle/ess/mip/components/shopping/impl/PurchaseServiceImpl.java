...
public class PurchaseServiceImpl implements PurchaseService {
    ...
    @Override
    public void purchaseCartAtTouchpointForCustomer(PurchaseDTO dto) throws ShoppingException {
        this.customer = customerCRUD.readCustomer(dto.customerId);
        this.touchpoint = touchpointAccess.readTouchpoint(dto.touchpointId);
        this.shoppingCart = new ShoppingCartEntity();
        shoppingCartService.getItems(dto.shoppingCartId).forEach(
                item -> this.shoppingCart.addItem(item)
        );
        this.purchase();
